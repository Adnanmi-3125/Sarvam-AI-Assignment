...
const Discover = () => {
  ...
  return (
    <div className="w-full lg:w-[375px] lg:border-r lg:border-neutral-300 flex flex-col bg-[#F7EFE3] h-[100vh] overflow-auto no-scrollbar">
      ...
      <div className="flex items-center py-5 mt-16 rounded-t-[28px] md:mt-0 lg:px-6 text-3xl px-5 lg:hidden playfair-display">
        Good Evening!
      </div>
      ...
      <div className=" flex gap-x-5 lg:mt-16">
        ...
        <div className=" hidden sm:flex lg:hidden flex-col gap-y-5 overflow-auto no-scrollbar h-full">
          <div className=" flex gap-x-5 aspect-square mr-5">
            <Card />
          </div>
          <div className=" flex gap-x-5 h-[160px] mr-5">
            <CardWithTitle />
          </div>
          <div className=" flex gap-x-5 h-[160px] mr-5">
            <Card />
